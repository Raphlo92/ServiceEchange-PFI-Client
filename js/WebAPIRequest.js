...
const apiBaseURL= "https://tidal-shore-koi.glitch.me";
...
/* Section News */
function news_webAPI_HEAD(successCallBack, errorCallBack) {
    $.ajax({
        ...
        error: function(jqXHR) {
            errorCallBack(jqXHR.status);
            console.log("news_webAPI_GET_ALL - error");
        }
    });
}
function news_webAPI_GET_ALL(queryString, successCallBack, errorCallBack) {
    $.ajax({
...
function news_webAPI_GET( id, successCallBack, errorCallBack) {
    $.ajax({
        ...
        error: function(jqXHR) {
            errorCallBack(jqXHR.status);
            console.log("news_webAPI_GET - error");
        }
    });
}
function news_webAPI_POST( data , successCallBack, errorCallBack) {
    $.ajax({
        url: apiBaseURL + "/api/news",
        type: 'POST',
        headers: getBearerAuthorizationToken(),
        ...
        error: function(jqXHR) {
            errorCallBack(jqXHR.status);
            console.log("news_webAPI_POST - error");
        }
    });
}
function news_webAPI_PUT(data, successCallBack, errorCallBack) {
    $.ajax({
        ...
        error: function(jqXHR) {
            errorCallBack(jqXHR.status);
            console.log("news_webAPI_PUT - error");
        }
    });
}
function news_webAPI_DELETE( id, successCallBack, errorCallBack) {
    $.ajax({
        url: apiBaseURL + "/api/news" + "/" + id,
        contentType:'text/plain',
        type: 'DELETE',
        ...
        error: function(jqXHR) {
            errorCallBack(jqXHR.status);
            console.log("news_webAPI_DELETE - error");
        }
    });
}
